...
* **Patient Reported** are fields that a patient communicates to the case manager. These fields are often unverifiable but often do not have any impact on ability to fund, depending on which Fund is using DARIA.
...
------------ | ------------- | ------------- | ------------- | -------------
**Name** | Patient's name (First and Last) | Not Exportable | Patient Reported | Text field
...
**Resolved Without Fund** | The patient has resolved their case without the aid of the Fund. This could be a patient chooses to continue the pregnancy, has found other sources of funding, or any other circumstances such that the Fund should not continue contacting the patient. | Exportable | Patient Reported | Checkbox
...
**Referred to Clinic** | Check box to indicate if CM referred patient to clinic where they had their procedure. | ??? | CM Reported | Checkbox
